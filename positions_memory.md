...
## AMZN
- **Status**: pending
- **Order ID**: 7402179a-aedd-4a0a-8554-e3d043024a4e
- **Entry date**: 2026-08-28
- **Planned entry**: $267.50 (consolidation high)
- **Planned qty**: 20
- **Setup**: Breakout A
- **Initial stop**: $255.02 (consolidation low)

**Stop history:**
- 2026-08-28: $255.02 — initial stop (order pending fill)
